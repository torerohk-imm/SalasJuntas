...
- Si aparece `SyntaxError: Unexpected identifier` apuntando a `import express from ...`, asegúrate de tener **la última versión del repositorio** (ya compatible con CommonJS):
...
- Después reinstala dependencias y reinicia el servicio:
