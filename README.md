...
### 5.5 Instalar dependencias Node y construir frontend
...
### 5.6 Publicar frontend estático en Apache
...
### 5.7 Configurar servicio systemd para backend
...
### 5.8 Configurar VirtualHost Apache
...
### 5.9 (Recomendado) Configurar HTTPS con Let’s Encrypt
